...
### Shadow Vocabulary
- **Hint Lift** (`shadow-lg`): Search Hint and action menus that float over the Note List.
...
- **Search Hint:** Temporary overlay below Search, theme-aware and readable in Light and Dark.
