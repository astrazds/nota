...
Current behavior and data movement are described in [the user guide](docs/usage.md).
Implementation ownership belongs in [the architecture guide](docs/architecture.md);
visual rules belong in [DESIGN.md](DESIGN.md).
