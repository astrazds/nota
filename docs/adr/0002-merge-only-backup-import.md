...
Before applying a Merge Import, Noter shows a Backup Import Preview that validates the selected Backup and reports how many Notes will be added or replaced. Selecting a Backup file is therefore not itself a mutating action.
