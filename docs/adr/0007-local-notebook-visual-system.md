...
- Extend browser visual contracts to check emitted CSS, computed font families, desktop Tag chip sizing and edit flow, mobile touch targets, writing measure, theme contrast, footer rhythm, startup notification quietness, labelled desktop actions, Preview/Split ordering, and editor title scale consistency.
